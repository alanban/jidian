...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mHeaderContainer.setBackgroundColor(Color.GREEN);
    ...
    public int getContentSize() {
        ...
        return (int) getResources().getDimension(R.dimen.picture_pull_to_refresh_height_height);
    }
    
    @Override
    protected View createLoadingView(Context context, ViewGroup root, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header, root, false);

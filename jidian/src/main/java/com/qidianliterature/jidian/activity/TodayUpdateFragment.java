 ...
 */
public class TodayUpdateFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.todayupdate_fragment_layout,null);
        init();
        return root;
    }
    ...
    private void init(){
        ...
        pullToRefreshListView = (PullToRefreshListView) root.findViewById(R.id.todayupdate_content_listview);

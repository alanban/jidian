...
public class RoundImageView extends ImageView
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		System.out.println("The width is "+widthMeasureSpec +"The height is "+heightMeasureSpec);
	...
	private void setUpShader()
	{
		...
		if (type == TYPE_CIRCLE)
		{
			System.out.println("The getWidth is "+bmp.getWidth() +"the getHeight is "+bmp.getHeight());
	...
	private Bitmap drawableToBitamp(Drawable drawable)
	{
		...
		Log.d("drawableToBitamp", "w'"+w+"h'"+h);
